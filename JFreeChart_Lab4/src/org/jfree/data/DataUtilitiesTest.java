...
public class DataUtilitiesTest {
	 ...
	 * testCalculateRowTotalNullData() throws InvalidParameterException {
	 * 
	...
	// Testing valid row index and data parameter which contains positive and
	// negative values
	@Test
	...
	/*
	 * @Test public void testCalculateRowTotalNegativeRowIndex() {
	 * 
	 * Mockery mockingContext = new Mockery(); final Values2D values =
	 * mockingContext.mock(Values2D.class); mockingContext.checking(new
	 * Expectations() { { one(values).getColumnCount(); will(returnValue(2));
	 * one(values).getRowCount(); will(returnValue(1)); one(values).getValue(0, 0);
	 * will(returnValue(4.0)); one(values).getValue(0, 1); will(returnValue(4.0));
	 * 
	 * } });
	 * 
	 * double calculationResult = DataUtilities.calculateRowTotal(values, -1);
	 * assertEquals("Calculate total with negative row index should be zero", 0.0,
	 * calculationResult, .000000001d);
	 * 
	 * }
	 */
	...
	/*
	 * @Test public void testCalculateRowTotalRowIndexAUB() {
	 * 
	 * Mockery mockingContext = new Mockery(); final Values2D values =
	 * mockingContext.mock(Values2D.class); mockingContext.checking(new
	 * Expectations() { { one(values).getColumnCount(); will(returnValue(2));
	 ...
	 * 
	 * double calculationResult = DataUtilities.calculateRowTotal(values, 1);
	 * assertEquals("Calculate total with AUB row index should be zero", 0.0,
	 * calculationResult, .000000001d);
	 * 
	 * }
	 */
	...
	/*
	 * @Test (expected = InvalidParameterException.class) public void
	 * testCreateNumberArrayNullData() throws InvalidParameterException {
	 * 
	...
	/*
	 * @Test(expected = InvalidParameterException.class) public void
	 * calculateColumnTotalNullData() { double actualColumnTotal =
...
//    }
	...
	/*
	 * @Test(expected = InvalidParameterException.class) public void
	 * calculateColumnTotalNegativeColumn() { Mockery mockingContext = new
	 * Mockery(); final Values2D values = mockingContext.mock(Values2D.class);
	 * 
	 * mockingContext.checking(new Expectations() { { one(values).getRowCount();
	 * will(returnValue(3));
	 * 
	 * one(values).getValue(0, 0); will(returnValue(1000)); } });
	 * 
	 * double expectedColumnTotal = 0; double actualColumnTotal =
	 * DataUtilities.calculateColumnTotal(values, -1);
	 * assertEquals("The column total should be 0", expectedColumnTotal,
	 * actualColumnTotal, .000000001d); }
	 */
	...
	/**
	 * This test is creates an array of array of Number objects by accepting double
	 * primitives. This test asserts that a 2 row, 2 column positive value array of
	 * double is created.
	 **/

	/*
	 * @Test public void createNumber2DArrayPositive() { //create expected array
	 * Number[][] expectedArray = {{1, 5},{2, 6}}; //create array of double to pass
	 * through the method double[][] inputArray = {{1, 5},{2, 6}}; //call method to
	 * create Number array of arrays Number[][] actualArray =
	 * DataUtilities.createNumberArray2D(inputArray); //assert actual and expected
	 * array of arrays assertArrayEquals(expectedArray, actualArray); }
	 */

	/**
	 * This test is creates an array of array of Number objects by accepting double
	 * primitives. This test asserts that a 2 row, 2 column negative value array of
	 * double is created.
	 **/

	/*
	 * @Test public void createNumber2DArrayNegative() { //create expected array
	 * Number[][] expectedArray = {{-1, -5},{-2, -6}}; //create array of double to
	 * pass through the method double[][] inputArray = {{-1, -5},{-2, -6}}; //call
	 * method to create Number array of arrays Number[][] actualArray =
	 * DataUtilities.createNumberArray2D(inputArray); //assert actual and expected
	 * array of arrays assertArrayEquals(expectedArray, actualArray); }
	 */
	...
	/**
	 * This test is creates an array of array of Number objects by accepting double
	 * primitives. This test asserts that a 2 row, 2 column positive decimal value
	 * array of double is created.
	 **/
	...
	/**
	 * This test is creates an array of array of Number objects by accepting double
	 * primitives. This test asserts that a 2 row, 2 column negative decimal value
	 * array of double is created.
	 **/
	...
	/**
	 * This test is creates an array of array of Number objects by accepting double
	 * primitives. This test asserts that a null 2D array passed into
	 * createNumberArray2D The assert will throw an exception
	 **/

	/*
	 * @Test (expected = InvalidParameterException.class) public void
	 * createNumber2DArrayNull() throws InvalidParameterException{ //try{ //create
	 * null array to pass through the method double[][] inputArray = null; //call
	 * method DataUtilities.createNumberArray2D(inputArray); //
	...
	/*
	 * @Test(expected = InvalidParameterException.class) public void
	 * getCumulativePercentagesNullData() { KeyedValues actualCumulativePercentage =
	...
	public void getCumulativePercentagesEmptyData() {
		...
		KeyedValues actualCumulativePercentage = DataUtilities.getCumulativePercentages(keyedValues);
		assertEquals("Cumulative percentage return value for empty data argument should have 0 items", 0,
				actualCumulativePercentage.getItemCount());
	}
	...
	public void getCumulativePercentagesNonEmptyData() {
		...
		KeyedValues actualCumulativePercentage = DataUtilities.getCumulativePercentages(keyedValues);
		assertEquals("Cumulative percentage return value for index 1 should be 0.875", 0.875,
	...
	public void getCumulativePercentagesDataHasOnlyZeroes() {
		...
		KeyedValues actualCumulativePercentage = DataUtilities.getCumulativePercentages(keyedValues);
		assertTrue("Cumulative percentage return value for data argument with only zeroes should be NaN",
				Double.isNaN((double) actualCumulativePercentage.getValue(0)));
	}*/
	...
	public void getCumulativePercentagesDataHasZeroesAndNonZeroes() {
		...
		KeyedValues actualCumulativePercentage = DataUtilities.getCumulativePercentages(keyedValues);
		assertEquals("Cumulative percentage return value for index 0 should be 0.714", 5.0 / 7.0,
				actualCumulativePercentage.getValue(0));
	}

	// Test data with negative values
	/*
	 * @Test(expected = InvalidParameterException.class) public void
	 * getCumulativePercentagesDataHasNegativeValues() { Mockery mockingContext =
	 * new Mockery(); final KeyedValues keyedValues =
	 * mockingContext.mock(KeyedValues.class);
	 * 
	 * mockingContext.checking(new Expectations() { {
	 * allowing(keyedValues).getItemCount(); will(returnValue(3));
	 * allowing(keyedValues).getKeys(); will(returnIterator(0, 1, 2));
	 * allowing(keyedValues).getValue(0); will(returnValue(-5));
	 * allowing(keyedValues).getValue(1); will(returnValue(-9));
	 * allowing(keyedValues).getValue(2); will(returnValue(-2));
	 ...
	 * 
	 * KeyedValues actualCumulativePercentage =
